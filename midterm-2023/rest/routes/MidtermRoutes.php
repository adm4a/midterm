<?php
Flight::map('midterm_service', function() {
    return new MidtermService();
});
...
Flight::route('GET /cap-table', function(){
    ...
    */
    Flight::json(Flight::midterm_service()->cap_table());
...
Flight::route('GET /summary', function(){
    ...
    * This endpoint should return output in JSON format
    */
    Flight::json(Flight::midterm_service()->summary());
...
Flight::route('GET /investors', function(){
    ...
    * This endpoint should return output in JSON format
    */
    Flight::json(Flight::midterm_service()->investors());
